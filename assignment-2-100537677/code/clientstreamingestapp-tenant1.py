...
report_topic = "tenant1" + "_" + args['topic_name'] + "_report"
...
def start():
    db = connect_to_mongo("mongodb://localhost:27117", "airbnb", "listing_tenant1")
    consumer_group = "clientstreamingestapp-tenant1"
    c = Consumer({
